...
<table border="0" cellpadding="1" cellspacing="0" width="100%" style="text-align:center; vertical-align:middle;">
    <tr>
        <td style="width:250px; vertical-align:middle; height:50px;">
            @If Not User.Identity.IsAuthenticated Then
                'show log-out button
                @<a id="auth-loginlink" href="">Log In With Facebook</a>
            Else
                'show log-in button
                '@<a id="auth-logoutlink" href="">Log Out</a>
        ...
        @If User.Identity.IsAuthenticated Then
            @<td style="width:60px;">
                <img src="https://graph.facebook.com/@(User.Identity.Name)/picture/" alt="Profile Picture" width="45px;" />
            </td>
        End If
        <td style="text-align:left;">
            @If Not User.Identity.IsAuthenticated Then
                ...
                End Using
            Else
                @<span> Welcome <span id="auth-displayname">@(model.FB_Name)</span></span>
            End If
